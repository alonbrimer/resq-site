...
if ( 'posts' == get_option( 'show_on_front' ) && $responsive_options['front_page'] != 1 ) {
    ...
    <div id="featured" class="grid col-940 center">
...
//				?>
<!--			</h2>-->
            <div class="welcome-resq center">
                <div class="resq-logo">
                    <img src="<?php bloginfo('url');?>/wp-content/uploads/2014/05/large-logo.png?>" >
                </div>
                <h1>WELCOME TO RES-Q</h1>
            </div>
...
<!--		</div>-->
        ...
        <iframe width="640" height="390" src="//www.youtube.com/embed/EySnDhI11pQ" frameborder="0" allowfullscreen></iframe>
